...
// Avoid stuttering
✅ manager.Start()
❌ tenantManager.StartTenantManager()
...
❌ func GetTenant(id string) (tenant *Tenant, err error)
```
...
- [Implementation Status](12-implementation-status.md)
- [Code README](../../core/enterprise/README.md)
...
For questions, open an issue or join our Discord.
